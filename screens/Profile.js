...
import {StyleSheet, View , TouchableOpacity, ScrollView, Keyboard, StatusBar } from 'react-native';
...
import ProfileRow2 from '../components/Profile/ProfileRow2';
        ...
        <>
            ...
            <View style={appendStyle.contentContainer}>
                <View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("support")} style={appendStyle.profileRow}>
                        ...
                        <View style={{ flexDirection : 'row' , alignItems : 'center' }}>
                            ...
                            <View style={appendStyle.rowIconContainer}>
                                <Ionicons name="help-buoy-outline" size={24} style={appendStyle.rowIcon} />
                            </View>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('reminder')} style={appendStyle.profileRow}>
                        <View style={appendStyle.goToRouteTrigger}>
                            <Feather name="chevron-left" size={24} color="black" />
                            </View>
                        <View style={{ flexDirection : 'row' , alignItems : 'center' }}>
                            <Para size={18} weight="bold">یادآور</Para>   
                            <View style={appendStyle.rowIconContainer}>
                                <Feather name="calendar" size={24} style={appendStyle.rowIcon} />
                            </View>
                        </View>
                    </TouchableOpacity>
