...
import { Image, ScrollView, StyleSheet, View , TouchableOpacity, ViewPropTypes } from 'react-native';
...
const Profile = () => {
    ...
    // TODO handle dynamic input ( id key was inside default inputValues then we create and can see that input )
    // TODO handle some case of input component like BirthDay or Gender
        ...
        <>
            <View>
                ...
                <View style={appendStyle.avatar}>
                    <View>
                    <Feather name="user" size={100} color={generateColor(primary , 8)} />
            ...
            <View style={appendStyle.contentContainer}>
                <View>
                    <ProfileRow icon="edit-2" label="ویرایش حساب"></ProfileRow>
